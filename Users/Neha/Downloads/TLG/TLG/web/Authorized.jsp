...
<form action="Authorized" method="post"><div class="loginbox">
        <% 
                    String email =(String)session.getAttribute("email");
                %>
<div class="logtxt">Email Verification</div>
<div class="loginput"><h6>Yes,This is my Email Id Press Ok to continue... </h6></div>
<div class="loginput"><label><%=email%></label></div>
...
<input name="submit" type="submit" value="Ok" class="logbutton"/>
</form>

<!--//<a href="register.jsp"><input name="submit" type="submit" class="logbutton" value="No, this is not my id"/></a>-->
</div>
