 ...
 * @author Neha
 */
@WebServlet(name = "history_disapprove", urlPatterns = {"/history_disapprove"})
public class history_disapprove extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try{
        Connection con = DBConnections.getConnection();
               ...
               PreparedStatement pst1 = con.prepareStatement("insert into disapproved_orders(order_id,driver_id,cust_name,start_address,date,pickup_time,destination_address,mobile_no) values(?,?,?,?,?,?,?,?)");
             ...
             pst1.execute();
             System.out.println("inserted disapproved");
      request.getRequestDispatcher("driver_orders.jsp").forward(request, response);
